...
def test_add_new_book_valid_len_name(collector):
...
def test_set_book_genre_with_valid_genre(collector):
    book_name = 'Война и Мир'
    genre = 'Ужасы'
    collector.add_new_book(book_name)
...
def test_get_book_genre_get_by_name(collector):
...
def test_get_books_with_specific_genre_empty_collector(collector):
    assert collector.get_books_with_specific_genre('Фантастика') == []


def test_get_books_with_specific_genre_one_book(collector):   
    book_name = 'Гарри Поттер'
    genre = 'Фантастика'
    collector.add_new_book(book_name)
    collector.set_book_genre(book_name, genre)
...
def test_get_books_genre_with_multiple_books(collector):
...
def test_get_books_for_children_no_children_books(collector):
...
def test_add_book_in_favorites_new_book(collector):
...
def test_delete_existing_book_from_favorites(collector):
...
def test_get_list_of_favorites_books_get_empty_favorites_list(collector):
